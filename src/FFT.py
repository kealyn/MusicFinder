...
class FFT:
    ...
    '''
    def run(self, channel_samples, fs=RunParams.Default_Frequency_Rate, width=RunParams.Default_Width_FFT, 
            overlap_ratio=RunParams.Default_Overlap_Ratio):
        ...
        (spectrum, freqs, t) = mlab.specgram(channel_samples, NFFT=width, Fs=fs, 
                            window=mlab.window_hanning, noverlap=int(width * overlap_ratio))
